const shortcutDropdownData = (t, configData) => {
	return [
		{
			group: "Core",
			actions: configData?.modules?.includes("core")
				? [
						{
							id: "customer",
							label: t("CustomerN"),
		...
		},
		{
			...
			actions: configData?.modules?.includes("sales-purchase")
				? [
						{
							id: "sales",
							label: t("SalesN"),
		...
		{
			group: "Inventory",
			actions: configData?.modules?.includes("inventory")
				? [
						{
							id: "category",
							label: t("CategoryN"),
		...
		{
			group: "Production",
			actions: configData?.modules?.includes("production")
				? [
						{
							id: "items",
		...
		{
			group: "Domain",
			actions: configData?.modules?.includes("domain")
				? [
						{
							id: "",
							label: t("DomainN"),
		...
		{
			group: "Accounting",
			actions: configData?.modules?.includes("accounting")
				? [
						{
							id: "transaction-mode",
		...
		{
			group: "Procurement",
			actions: configData?.modules?.includes("procurement")
				? [
						{
