				...
				<ScrollArea h={height + 100} scrollbarSize={2} type="never" bg={"gray.1"}>
					...
					<Box ml={2} mr={2} mt={0} p={"xs"} className="borderRadiusAll" bg={"white"}>
						<Box bg={"white"} p={"xs"} className={"borderRadiusAll"} h={height - 37}>
							{props.module === "customer" && (
								<CustomerFilterForm module={props.module} />
							)}
							{props.module === "warehouse" && (
								<WarehouseFilterForm module={props.module} />
							)}
							...
							{props.module === "product" && (
								<ProductFilterForm module={props.module} />
							)}
							{props.module === "category" && (
								<CategoryFilterForm module={props.module} />
							)}
							{props.module === "production-setting" && (
								<__ProductionSettingFilterForm module={props.module} />
							)}
						</Box>
						<Box
							pl={`xs`}
