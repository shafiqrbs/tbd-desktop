...
function _GenericInvoiceForm(props) {
	const { currencySymbol, isPurchaseByPurchasePrice, isWarehouse } = props;
	...
	let totalPurchaseAmount =
		tempCardProducts?.reduce((total, item) => total + item.purchase_price * item.quantity, 0) ||
		0;
	...
	const inputGroupText = (
		<Text ta={"right"} style={{ width: "100%", paddingRight: 16 }} color={"gray"}>
