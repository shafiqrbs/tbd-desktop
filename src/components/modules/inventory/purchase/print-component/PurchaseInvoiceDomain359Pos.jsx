								...
								<div className={classes["pos-body"]}>
									<header className={classes["body-head"]}>
										<div className={classes["pos-head"]}>
											...
											/>
											<h3 className={classes["head-title"]}>
											...
											<Grid
												columns={24}
												gutter={0}
												className={`${classes["head-address"]} ${classes["text-width-two"]}`}
												mb={"xs"}
											>
									...
									<main className={classes["body-main"]}>
										...
										<div className={classes["main-invoice"]}>
											<div className={classes["invoice-details"]}>
												...
												>
													...
													<Grid.Col span={16}>
														{invoicePrintData &&
															invoicePrintData.sales_by_username &&
															invoicePrintData.sales_by_username}
													</Grid.Col>
												</Grid>
												<Grid
													...
													className={`${classes["invoice-text"]} ${classes["text-width-two"]}`}
												>
													<Grid.Col span={6}>{t("Mode")}</Grid.Col>
													<Grid.Col span={2}>:</Grid.Col>
													<Grid.Col span={16}>
														{invoicePrintData &&
															invoicePrintData.mode_name &&
															invoicePrintData.mode_name}
													</Grid.Col>
												</Grid>
												<Grid
													...
													className={`${classes["invoice-text"]} ${classes["text-width-two"]}`}
												>
													<Grid.Col span={6}>{t("Process")}</Grid.Col>
													<Grid.Col span={2}>:</Grid.Col>
													<Grid.Col span={16}>
														{invoicePrintData &&
															invoicePrintData.process_id &&
															invoicePrintData.process_id}
													</Grid.Col>
												</Grid>
											</div>
										...
										<div className={classes["main-address"]}>
											<Grid
												...
												className={`${classes["invoice-text"]} ${classes["text-width-two"]}`}
											>
												<Grid.Col span={6}>{t("Vendor")}</Grid.Col>
												<Grid.Col span={2}>:</Grid.Col>
												<Grid.Col span={16}>
													{invoicePrintData &&
														invoicePrintData.customer_name &&
														invoicePrintData.customer_name}
												</Grid.Col>
											</Grid>
											<Grid
											...
											>
												...
												<Grid.Col span={16}>
													{invoicePrintData &&
														invoicePrintData.customer_mobile &&
														invoicePrintData.customer_mobile}
												</Grid.Col>
											</Grid>
											<Grid
											...
											>
												...
												<Grid.Col span={16}>
													{invoicePrintData &&
														invoicePrintData.customer_address &&
														invoicePrintData.customer_address}
												</Grid.Col>
											</Grid>
										</div>
										...
										<table style={{ width: "78mm" }}>
											<tbody>
												{invoicePrintData &&
													invoicePrintData.sales_items &&
													invoicePrintData.sales_items.map(
														(element, index) => (
										...
										<footer className={classes["body-footer"]}>
											...
											>
												...
												>
													{invoicePrintData &&
														invoicePrintData.sub_total &&
														Number(invoicePrintData.sub_total).toFixed(
															2
														)}
												</p>
											</div>
											<div className={classes["footer-items"]}>
												...
												>
													{invoicePrintData &&
														invoicePrintData.discount &&
														Number(invoicePrintData.discount).toFixed(
															2
														)}
												</p>
											</div>
											<div className={classes["footer-items"]}>
												...
												>
													{invoicePrintData &&
														...
														Number(invoicePrintData.total).toFixed(2)}
												</p>
											</div>
											<h3 className={classes["table-title"]}></h3>
											<div className={classes["footer-items"]}>
												...
												>
													{invoicePrintData &&
														...
														Number(invoicePrintData.payment).toFixed(2)}
												</p>
											</div>
											<h3 className={classes["table-title"]}></h3>
											<div className={classes["footer-items"]}>
												...
												>
													{invoicePrintData &&
														invoicePrintData.total &&
														(
															Number(invoicePrintData.total) -
															Number(invoicePrintData.payment)
														).toFixed(2)}
												</p>
											</div>
											<Text
