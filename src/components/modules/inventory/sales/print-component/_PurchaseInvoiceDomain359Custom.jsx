									...
									<main className={classes["invoice-body-main"]}>
												...
												<Box>
													<Group justify="center" gap="xs">
														...
														>
															...
															<Text h={18} fw={"300"} fz={"12"}>
																{invoicePrintData &&
																	invoicePrintData.created_by_user_name &&
																	invoicePrintData.created_by_user_name}
															</Text>
															<Text h={18} fw={"300"} fz={"12"}>
																{invoicePrintData &&
										...
										<div className={classes["invoice-body-table-section"]}>
											<table className={classes["invoice-body-table"]}>
												<thead>
													<tr
														className={classes["invoice-body-table-tr"]}
													>
														<th
											...
											<Box>
												<Center>
													<img
														src={barCode}
														alt=""
														className={classes["invoice-footer-img"]}
													/>
												</Center>
											</Box>
											<Box>
