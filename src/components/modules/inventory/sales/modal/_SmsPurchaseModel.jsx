	...
	const card = (
		<Card withBorder radius="md" className={classes.card}>
			...
			<Text fz="sm" c="dimmed" lineClamp={4}>
				...
				different direction to its predecessor, namely the fact that this time round instead
				of fighting against various mutated zombies, you’re now dealing with more occult
				enemies like werewolves and vampires.
			</Text>
